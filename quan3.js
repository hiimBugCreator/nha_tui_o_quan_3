const BasemapEnum = {
	STREETS: {
		key: "streets",
		name: "Bản đồ giao thông thông thường, phù hợp cho hiển thị đường phố và các địa điểm.",
	},
	STREETS_VECTOR: {
		key: "streets-vector",
		name: "Phiên bản vector của bản đồ giao thông.",
	},
	TOPO: {
		key: "topo",
		name: "Bản đồ địa hình với thông tin chi tiết về các khu vực tự nhiên.",
	},
	TOPO_VECTOR: {
		key: "topo-vector",
		name: "Phiên bản vector của bản đồ địa hình.",
	},
	GRAY: {
		key: "gray",
		name: "Bản đồ nền xám (ảnh raster), đơn giản và dễ nhìn.",
	},
	GRAY_VECTOR: {
		key: "gray-vector",
		name: "Bản đồ nền xám phiên bản vector.",
	},
	DARK_GRAY: {
		key: "dark-gray",
		name: "Bản đồ nền xám tối (raster), thích hợp cho giao diện ban đêm.",
	},
	DARK_GRAY_VECTOR: {
		key: "dark-gray-vector",
		name: "Bản đồ nền xám tối (vector).",
	},
	SATELLITE: {
		key: "satellite",
		name: "Ảnh vệ tinh cho phép quan sát từ góc nhìn thực tế.",
	},
	HYBRID: {
		key: "hybrid",
		name: "Ảnh vệ tinh kết hợp với địa danh và đường giao thông.",
	},
	OCEANS: {
		key: "oceans",
		name: "Bản đồ đại dương, chuyên dụng cho các ứng dụng hàng hải.",
	},
	NATIONAL_GEOGRAPHIC: {
		key: "national-geographic",
		name: "Bản đồ phong cách National Geographic.",
	},
	TERRAIN: {
		key: "terrain",
		name: "Bản đồ địa hình với các lớp độ cao và đường nét.",
	},
	STREETS_RELIEF_VECTOR: {
		key: "streets-relief-vector",
		name: "Bản đồ giao thông với địa hình nổi.",
	},
	NAVIGATION_VECTOR: {
		key: "navigation-vector",
		name: "Bản đồ chỉ dẫn đường dành cho ứng dụng giao thông.",
	},
	STREETS_NIGHT_VECTOR: {
		key: "streets-night-vector",
		name: "Phiên bản ban đêm của bản đồ giao thông.",
	},
	OUTDOORS: {
		key: "outdoors",
		name: "Bản đồ ngoài trời dành cho du lịch hoặc dã ngoại.",
	},
};
